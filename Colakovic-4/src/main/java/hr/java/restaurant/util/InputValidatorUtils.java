...
public class InputValidatorUtils {
     ...
     */
    public static void checkForDuplicateEmployee(String firstName, String lastName, List<Person> employees)
     ...
     */
    public static void checkForDuplicateRestaurantName(String name, List<Restaurant> restaurants)
            throws DuplicateEntryException {
    ...
    /**
     * Provjerava duplicirane unose u listi na osnovu zadatog uslova.
     *
     * @param items   Lista elemenata za provjeru.
     * @param predicate Uslov za pronalaženje duplikata.
     * @param errorMessage Poruka koja se baca u slučaju duplikata.
     * @param <T> Tip elemenata u listi.
     * @throws DuplicateEntryException ako se pronađe duplikat.
     */
    public static <T> void checkForDuplicate(
            List<T> items,
            Predicate<T> predicate,
            String errorMessage) throws DuplicateEntryException {
